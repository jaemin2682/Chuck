    ...
    <div class="modal modal-overlay" @click.self="close">
      <div class="modal-window">
        ...
        <footer class="modal-footer">
          <button class="assginButton" @click="assgin">
            양도하고 탈퇴하기
          </button>
...
export default {
  ...
  methods: {
    ...mapMutations(["setVisibleModalSecedeGroup"]),
    close() {
      this.setVisibleModalSecedeGroup(false);
    },
    delete() {
      //탈퇴하기
      api
        .delete(`groups/${this.groupInfo.id}/` + store.getters.getId, {
          headers: {
